...
public class myhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        adminValues.put("username", "1");
        adminValues.put("password", "1");
        ...
        String createTableYeuCauPhieuMuon = "CREATE TABLE yeucauphieumuon (" +
                "id_phieumuon INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "masp INTEGER, " +
                "tentp TEXT, " +
                "tennguoimuon TEXT, " +
                ...
                "ngaymuon DATE, " +
                "ngaytra DATE)";
        db.execSQL(createTableYeuCauPhieuMuon);
        String createThongBaoTable = "CREATE TABLE thongbao ("
                + "id INTEGER PRIMARY KEY AUTOINCREMENT, "
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS yeucauphieumuon");
